...
export default function MakeSubscriptionModal(props) {
  ...
  const handleSubscribe = () => {
    ...
    props.handleSubscribe(subscriptionData)
  }
        ...
        <div className='form' style={{paddingTop: 12}}>
          ...
          <div className={classes.actionGroup}>
            <Select 
              ...
              value={subscriptionData.day_of_month}
              onChange={e=>setSubscriptionData({...subscriptionData, day_of_month: e.target.value})}
            >
              {[...Array(28).keys()].map(i=>
