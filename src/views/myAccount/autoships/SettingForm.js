...
export default function SettingForm () {
  ...
  const checkLessCredit = () => {
    callGetApiWithAuth('autoship_setting/check_credit', onCheckCredit)
  }
  ...
  const handleSave = () => {
    setIsUpdating(true)
    callPutApiWithAuth('autoship_setting/setting', settingData, onSettingUpdate, onSettingFail)
  }
        ...
        <div className={classes.payTypeRoot}>
          ...
          <SelectField className={classes.payTypeSelect}
            ...
            options={[
              ...
              { label: 'Product Credit & CC', value: 6 }
            ]}
          />
          <Button 
            variant="contained"
