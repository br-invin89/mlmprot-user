...
import autoshipData from 'testdata/post_autoship_data.json'
...
const headCells = [
  ...
  { id: 'last_billing_date', label: 'Last Billing Date' },
]
...
export default function ProductsTable() {
  ...
  const loadData = (paginationParam) => {
    ...
    callGetApiWithAuth('autoships/past_autoships?' + paramsQuery, onGetTableData)
  }
