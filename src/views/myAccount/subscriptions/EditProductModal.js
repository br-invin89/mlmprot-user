...
export default function EditProductModal({ data, closeEdition, afterSuccessUpdate }) {
  ...
  const onSuccessUpdate = () => {
    setIsUpdating(false)
    closeEdition()
    afterSuccessUpdate('Subscription updated.')
  }
      ...
      <Modal open={data} onClose={closeEdition} className={classes.modal}>
        <Fade in={data}>
          <div className={classes.modalRoot}>
            <Typography component={'h2'}>Edit Subscription #{data.id}</Typography>
                      ...
                      if (detail.isNew) {
                        ...
                        return (
                          <TableRow className={classes.td}>
                            ...
                            <TableCell>
                              {detail.product.pc_amount * detail.quantity}
                            </TableCell>
                            <TableCell>
                              {detail.product.sc_amount * detail.quantity}
                            </TableCell>
                            <TableCell>
